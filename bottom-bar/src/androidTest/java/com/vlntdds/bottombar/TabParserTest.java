...
public class TabParserTest {
    ...
    public void setUp() throws Exception {
        ...
        tabs = new TabParser(
                ...
                com.vlntdds.bottombar.test.R.xml.dummy_tabs_five
        ).parseTabs();
    }
    ...
    public void correctActiveColors() {
        ...
        assertEquals(
                ContextCompat.getColor(context, com.vlntdds.bottombar.test.R.color.test_random_color),
    ...
    public void iconResourceIdsAsExpected() {
        int expectedId = com.vlntdds.bottombar.test.R.drawable.empty_icon;
