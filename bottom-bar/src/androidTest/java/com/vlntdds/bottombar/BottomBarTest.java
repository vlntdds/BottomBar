...
public class BottomBarTest {
    private static final int THREE_TABS = com.vlntdds.bottombar.test.R.xml.dummy_tabs_three;
    ...
    private static final int TITLE_TEXT_APPEARANCE = com.vlntdds.bottombar.test.R.style.dummy_text_appearance;
    ...
    public void setItems_AfterAlreadySet_ReplacesPreviousWithNewOnes() {
        ...
        bottomBar.setItems(com.vlntdds.bottombar.test.R.xml.dummy_tabs_five);
    ...
    public void setOnTabSelectListener_WhenShouldFireInitiallySetToTrue_FiresWhenSet() {
        ...
        verify(listener, times(2)).onTabSelected(com.vlntdds.bottombar.test.R.id.tab_favorites);
    }
    ...
    public void findingPositionForTabs_ReturnsCorrectPositions() {
        assertEquals(0, bottomBar.findPositionForTabWithId(com.vlntdds.bottombar.test.R.id.tab_favorites));
        assertEquals(1, bottomBar.findPositionForTabWithId(com.vlntdds.bottombar.test.R.id.tab_nearby));
        assertEquals(2, bottomBar.findPositionForTabWithId(com.vlntdds.bottombar.test.R.id.tab_friends));
    }

    @Test
    @UiThreadTest
    public void whenTabIsSelected_SelectionListenerIsFired() {
        bottomBar.selectTabWithId(com.vlntdds.bottombar.test.R.id.tab_friends);
        bottomBar.selectTabWithId(com.vlntdds.bottombar.test.R.id.tab_nearby);
        bottomBar.selectTabWithId(com.vlntdds.bottombar.test.R.id.tab_favorites);

        InOrder inOrder = inOrder(selectListener);
        inOrder.verify(selectListener, times(1)).onTabSelected(com.vlntdds.bottombar.test.R.id.tab_friends);
        inOrder.verify(selectListener, times(1)).onTabSelected(com.vlntdds.bottombar.test.R.id.tab_nearby);
        inOrder.verify(selectListener, times(1)).onTabSelected(com.vlntdds.bottombar.test.R.id.tab_favorites);
    ...
    public void afterConfigurationChanged_SavedStateRestored_AndSelectedTabPersists() {
        ...
        assertEquals(com.vlntdds.bottombar.test.R.id.tab_favorites, bottomBar.getCurrentTabId());
    }

    @Test
    @UiThreadTest
    public void whenTabIsReselected_ReselectionListenerIsFired() {
        int firstTabId = com.vlntdds.bottombar.test.R.id.tab_favorites;
        bottomBar.selectTabWithId(firstTabId);
        verify(reselectListener, times(1)).onTabReSelected(firstTabId);

        int secondTabId = com.vlntdds.bottombar.test.R.id.tab_nearby;
        bottomBar.selectTabWithId(secondTabId);
        bottomBar.selectTabWithId(secondTabId);
        verify(reselectListener, times(1)).onTabReSelected(secondTabId);

        int thirdTabId = com.vlntdds.bottombar.test.R.id.tab_friends;
    ...
    public void whenDefaultTabIsSet_ItsSelectedAtFirst() {
        int defaultTabId = com.vlntdds.bottombar.test.R.id.tab_friends;
    ...
    public void afterConfigurationChanged_UserSelectedTabPersistsWhenResettingDefaultTab() {
        ...
        assertEquals(com.vlntdds.bottombar.test.R.id.tab_nearby, bottomBar.getCurrentTabId());
    }
